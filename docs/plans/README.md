...
| Plan | Status | Notes |
|---|---|---|
| [2026-06-14-compile-launch-plan](2026-06-14-compile-launch-plan.md) | active | Mode B phase 1: `our compile` emits a deterministic manifest-to-Clawdapus launch projection. No execution, service invocation, credential resolution, descriptor fetch, or Clawdapus pod emitter in this slice. |
