...
| Plan | Status | Notes |
|---|---|---|
| [2026-06-10-execution-plane](2026-06-10-execution-plane.md) | active | Sessions + contained runners + manifest `services`; operator-approved combined path. Adoption marker decision updated in-room to Git intent-to-add. |
