...
| Plan | Status | Notes |
|---|---|---|
| [2026-06-12-contract-rules](2026-06-12-contract-rules.md) | shipped (v0.20.0) | Built-in Fleet Work Contract in baseline guidance + self-skill, `our fleet get` support-record next-step hint, manifest `contract` string list rendered as `## Organization Contract` in `AGENTS.md`. |
