...
- `manifest/` is the private control-plane repo shape: `manifest.json`,
  static skills, product/repo catalog files, and agent guidance.
- `content/` is the separate handbook content repo shape: customer identity
  records, meetings, support records, decisions, projects, policy, people, and
  fleet records.
